            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 fix-width">
                        <div class="grid_3 grid_5 wthree" data-spy="affix" data-offset-top="350" data-offset-bottom="200">
                            <h3>快速定位</h3>
                            <div class="skill-list">
                                ...
                                <div class="list-group list-group-alternate">
                                    ...
                                    <template v-for="(item, index) in list">
                                        <a href="javascirpt:;" @click="detail(item.sid)" class="list-group-item" :key="index"><span class="badge badge-primary">5021</span> <i class="ti ti-eye"></i> {{ item.title }} </a>
                                    </template>    
                    ...
                    <div class="col-md-9">
                        <div class="article">    
                            ...
                            <div class="article-detail" v-if="isCk">
                                <p v-html="article.content" v-highlightB></p>
                            </div>
