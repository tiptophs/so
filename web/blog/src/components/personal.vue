              ...
              <div class="personal-operations">
                <div class="list-group">
                  <router-link to="/personal"
                               ...
                               style="border-radius: 0px;">我的首页</router-link>
                  <router-link to="/personal/particle"
                               tag="a"
                               href="javascript:;"
                               class="list-group-item">琐碎笔记</router-link>
                  <router-link to="/personal/tools"
                               tag="a"
                               href="javascript:;"
                               class="list-group-item">工具库</router-link>
                  <a href="#"
                     class="list-group-item">页面控制</a>
                  <a href="#"
                     class="list-group-item"
                     style="border-bottom:1px solid #ccc;">分类管理</a>
                </div>
              </div>
            </div>
              ...
              <div class="top">
                <dl>
                  ...
                  <dd><a href="javascript:;"
                       class="btn-filter-sort "
                       target="_self">默认</a></dd>
                  <dd><a href="javascript:;"
                       class="btn-filter-sort active"
                       target="_self">按更新时间</a></dd>
                  <dd><a href="javascript:;"
                       class="btn-filter-sort "
                       target="_self">按访问量</a></dd>
                </dl>
              </div>
              <div class="articles-content">
                <template v-for="(item, index) in articles">
                  <div class="article-item"
                       :key="index">
                    <h3>
                      <router-link :to="{ name:'message', query:{ sid:item.sid } }"
                                   href="javascript:;">{{ item.title }}</router-link>
                    </h3>
                    <p>{{ item.desc }}</p>
                    <div class="bot">
                      <div class="art-meta">
                      ...
                      <div class="operation">
                        <a href="javascript:;"
                           @click="publish(item.sid)"
                           v-if="item.status==0"><i class="fa fa-smile-o"></i> 发布</a>
                        <a href="javascript:;"
                           @click="revoke(item.sid)"
                           v-if="item.status==1"><i class="fa fa-frown-o"></i> 撤销</a>
                        <router-link tag="a"
                                     :to="{ name:'particle', query:{ sid:item.sid } }"
                                     v-if="item.status==0"><i class="fa fa-edit"></i> 编辑</router-link>
                        <a href="javascript:;"
                           @click="delArticle(item.sid)"
                           v-if="item.status==0"><i class="fa fa-trash-o"></i> 删除</a>
                      </div>
                    </div>
                  </div>
                </template>
            ...
            <div class="pages">
              <ul class="pagination pagination-lg">
                <li><a href="javascript:;"
                     @click="getArticles( 1 )"><span aria-hidden="true">首页</span></a></li>
                <li><a href="javascript:;"
                     aria-label="Previous"><span aria-hidden="true">
                      << </span>
                         ...
                         <template
                         v-for="(item, index) in pageLine">
                <li :key="index"><a :class="{ active: item.isActive }"
                     @click="getArticles( item.page )"
                     href="javascript:;"><span aria-hidden="true">{{ item.page }}</span></a></li>
</template>

<li><a href="javascript:;"
     aria-label="Next"><span aria-hidden="true"> >> </span></a></li>
<li><a href="javascript:;"
     @click="getArticles( pageNum )"><span aria-hidden="true">末页</span></a></li>
</ul>
</div>
