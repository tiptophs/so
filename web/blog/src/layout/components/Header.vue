          ...
          <div class="navbar-header navbar-left">
            ...
            <h1>
              <router-link class="navbar-brand"
                           to="/home"> <span>S</span>oft</router-link>
            </h1>
          </div>
              ...
              <ul class="nav navbar-nav">
                ...
                <li v-if="showLogin">
                  <router-link to="/login"
                               class="login-button">登录</router-link>
                </li>
                ...
                <li v-if="showUser">
                  ...
                  <ul class="dropdown-menu">
                    <router-link to="/personal"
                                 tag="li"><a href="javascript:;">个人中心</a></router-link>
                    <li role="separator"
                        class="divider"></li>
                    <li><a href="#">后台登录</a></li>
                    <li role="separator"
